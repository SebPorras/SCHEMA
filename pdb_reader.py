...
import sys, os, math, string, pdb_reader
...
amino_acids = list(three_to_one_map.values())

class Atom:
	"Reads a PDB file ATOM line and extracts fields"
	
	# Field definitions taken from https://www.cgl.ucsf.edu/chimera/docs/UsersGuide/tutorials/pdbintro.html
